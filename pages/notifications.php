...
<style>
.notif-item{display:flex;gap:0.75rem;padding:0.85rem 1.2rem;border-bottom:1px solid var(--zt-border-light);cursor:pointer;transition:background .15s}
.notif-item:hover{background:var(--zt-accent-bg,rgba(0,180,160,.05))}
.notif-item.unread{background:rgba(0,180,160,.04);border-left:3px solid var(--zt-teal)}
