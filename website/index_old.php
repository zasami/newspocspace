  ...
  <div class="container">
    <div class="ws-nav-inner">
      <a href="#hero" class="ws-logo">
        <img src="EMS-Terrassire-SA-logo-web-1920w.webp" alt="E.M.S. La Terrassière SA" class="ws-logo-img">
      </a>
...
<section class="ws-hero" id="hero">
  ...
  <!-- Decorative birds SVG -->
  <svg class="ws-hero-birds" viewBox="0 0 800 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M120 80 Q140 60 160 80 Q140 70 120 80Z" fill="rgba(46,125,50,0.12)"/>
    <path d="M200 50 Q220 30 240 50 Q220 40 200 50Z" fill="rgba(46,125,50,0.08)"/>
    <path d="M600 60 Q620 40 640 60 Q620 50 600 60Z" fill="rgba(46,125,50,0.1)"/>
    <path d="M680 90 Q700 70 720 90 Q700 80 680 90Z" fill="rgba(46,125,50,0.06)"/>
    <path d="M350 40 Q370 20 390 40 Q370 30 350 40Z" fill="rgba(46,125,50,0.07)"/>
  </svg>
  <div class="container">
    <div class="ws-hero-content">
      <img src="EMS-Terrassire-SA-logo-web-1920w.webp" alt="E.M.S. La Terrassière SA" class="ws-hero-logo">
      <h1 class="ws-hero-title">Un lieu de vie<br>chaleureux et <span class="ws-accent">naturel</span></h1>
      ...
      <div class="ws-hero-actions">
        ...
        <a href="#services" class="ws-btn ws-btn-outline"><i class="bi bi-arrow-down"></i> Découvrir</a>
      </div>
    ...
    <div class="row g-4">
      <div class="col-lg-4">
        <div class="ws-footer-brand">
          <img src="EMS-Terrassire-SA-logo-web-1920w.webp" alt="E.M.S. La Terrassière SA" class="ws-footer-logo">
        </div>
